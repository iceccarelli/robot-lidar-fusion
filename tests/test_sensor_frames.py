...
def test_lidar_frame_creation() -> None:
    ...
    lf = LidarFrame(timestamp=1.234, frame_id="os_sensor", points_xyz=pts, intensities=intensities, metadata={})
...
def test_camera_frame_creation() -> None:
    ...
    cf = CameraFrame(timestamp=2.345, frame_id="camera", image=img, intrinsics=intrinsics, metadata={})
